...
export async function rpaController (req: Request, res: Response) {
    try{
        ...
        asyncCompletionViaWebHook({page: page, browser: browser, candidateData: candidateData});//Abstracts the upload bit away and fires off a webhook for successful or failed completion.

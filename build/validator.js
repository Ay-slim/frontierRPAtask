 ...
 */
var candidateDataSchema = joi_1.object({
 ...
 */
function validateCandidateData(req, res, next) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, candidateDataSchema.validateAsync(req.body)];
                case 1:
                    valid = _a.sent();
                    req.body = valid;
                ...
                case 2:
                    error_1 = _a.sent();
                    helpers_1.logger('error', (error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || error_1);
                    res.status(422).json({ status: 'failed', message: error_1.details[0].message });
                    return [3 /*break*/, 3];
